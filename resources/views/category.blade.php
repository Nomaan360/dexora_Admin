...
<div class="card">
  ...
  <div class="card-datatable text-nowrap">
    <div class="dataTables_wrapper">
      ...
      @endphp
      <form action="{{ route('category.update', $editData['id']) }}" enctype="multipart/form-data" method="post">
        {{ method_field("PUT") }}
      @else
            ...
            @php
                ...
                @if(isset($data['data']))
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="{{ route('category.edit',$pvalue['id'])}}"><button style="float:left;" type="button" class="btn btn-sm btn-icon btn-text-secondary rounded-pill delete-record waves-effect waves-light"><i class="ri-edit-circle-line ri-20px"></i></button></a>

                          <form action="{{ route('category.destroy', $pvalue['id'])}}" method="post">
                          @csrf
