...
<link rel="stylesheet" href="{{ public_path('vendor/pdfcss/pdf.css') }}" class="template-customizer-core-css" />
</head>
<body>
<div class="box">
  <ul class="left">
  ...
  <div class="ticket">
    ...
    <div class="content">
      ...
      <div class="sub-content">
        ...
        <span class="name">User NAME<br><span>{{ $ticket->username }}</span></span>
        <span class="flight">No. of tickets<br><span>{{ $ticket->numoftickets }}</span></span>
        {{-- <span class="flight">User Mail&deg;<br><span>{{ $ticket->username }}</span></span> --}}
        <span class="gate">Types of tickets<br><span>{{ $ticket->typeoftickets }}</span></span>
        <span class="boardingtime">LineId<br><span>{{ $ticket->lineid }}</span></span>
        <span class="flight flightslip">Generated ID&deg;<br>
          @foreach ($approvedtickets as $approves)
            <span>{{ $approves->generated_id }}</span>
          @endforeach
        </span>
