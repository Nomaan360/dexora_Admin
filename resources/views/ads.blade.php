...
<div class="card">
  <h5 class="card-header">Add Ads</h5>
            ...
            <div class="row">
              <div class="col-12 col-sm-6 col-lg-3 mb-3">
                <div class="form-floating form-floating-outline">
                  <input type="text" name="title" id="inputName" @if(isset($editData['title'])) value="{{$editData['title']}}" @endif class="form-control dt-input dt-full-name" data-column="1" placeholder="Enter Ad title" data-column-index="0" required>
                  <label for="inputName">Ad Title</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3 mb-3">
                <div class="form-floating form-floating-outline">
                  <input type="text" name="link" id="inputLink" @if(isset($editData['link'])) value="{{$editData['link']}}" @endif class="form-control dt-input dt-full-name" data-column="2" placeholder="Enter Ad link" data-column-index="0" required>
                  <label for="inputLink">Ad Link</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3 mb-3">
                <div class="form-floating form-floating-outline">
                  ...
                  <label for="floatingSelect">Ad Status</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-lg-3 mb-3">
                @if(isset($data['editData']))
            ...
            @php
                ...
                @if(isset($data['data']))
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="{{ route('ads.edit',$pvalue['id'])}}"><button style="float:left;" type="button" class="btn btn-sm btn-icon btn-text-secondary rounded-pill delete-record waves-effect waves-light"><i class="ri-edit-circle-line ri-20px"></i></button></a>
